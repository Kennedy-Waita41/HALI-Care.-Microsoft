            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="create.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Patients</a>
                    </div>
                    <?php
                    $conn = mysqli_connect("localhost", "root", "", "hali_care");
                                ...
                                while($row = $result->fetch_array()){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="delete.php?id='. $row['userID'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
